...
import net.mcreator.recollection.procedures.SteveOnInitialEntitySpawnProcedure;
import net.mcreator.recollection.procedures.SteveOnEntityTickUpdateProcedure;
...
public class SteveEntity extends Monster {
	public SteveEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(RecollectionModEntities.STEVE.get(), world);
	}
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		SteveOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		SteveOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}

	public static void init() {
		SpawnPlacements.register(RecollectionModEntities.STEVE.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
