...
@Mod("recollection")
public class RecollectionMod {
	public static final Logger LOGGER = LogManager.getLogger(RecollectionMod.class);
	public static final String MODID = "recollection";

	public RecollectionMod(FMLJavaModLoadingContext context) {
