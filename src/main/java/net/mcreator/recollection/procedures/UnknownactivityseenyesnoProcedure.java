...
import net.mcreator.recollection.network.RecollectionModVariables;
...
public class UnknownactivityseenyesnoProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (RecollectionModVariables.MapVariables.get(world).unknownactivitySEEN == false) {
			...
			RecollectionModVariables.MapVariables.get(world).unknownactivitySEEN = true;
			RecollectionModVariables.MapVariables.get(world).syncData(world);
		}
	}
}