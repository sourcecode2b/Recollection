...
public class SpawneyeballssurroundingyouProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), x, y, (z + 10), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 1), y, (z + 9), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 2), y, (z + 8), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 3), y, (z + 7), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 4), y, (z + 6), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 5), y, (z + 5), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 6), y, (z + 4), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 7), y, (z + 3), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 8), y, (z + 2), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 9), y, (z + 1), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x - 10), y, (z + 0), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), x, y, (z + 10), 1, 0, 1, 2, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x + 1), y, (z + 9), 1, 0, 2, 0, 0);
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (RecollectionModParticleTypes.DELETED_MOD_ELEMENT.get()), (x + 2), y, (z + 8), 1, 0, 2, 0, 0);
		...
		RecollectionMod.queueServerWork(170, () -> {
			world.setBlock(BlockPos.containing(x, y - 6, z), RecollectionModItems.DELETED_MOD_ELEMENT.get().defaultBlockState(), 3);
		});
	}
}